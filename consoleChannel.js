    ...
    $.ajax({
        ...
        if (data == "HOME") {
            ...
            if (parseInt(data) > 0) {
                ...
                window.location = "images/scavecgraph-viewBrohibited.svg";
...
function wrapBase64Image(data) {
    ...
    if (TRACKERSCALE != "1") {
        ...
        return "<img width=\"" + width + "\" height=\"" + height + "\" src=\"" + data.base64image + "\" class=\"trackerImage\" alt=\"Base64Image\" onclick=\"viewContextSvg('" + data.id + "',false,false);\" id=\"" + data.id + "\" title=\"" + data.id + "\"/>";
    } else {
